...
RUN echo "VITE_CONTENTFUL_SPACE_ID=${VITE_CONTENTFUL_SPACE_ID}" >> .env.production
RUN echo "VITE_CONTENTFUL_ACCESS_TOKEN=${VITE_CONTENTFUL_ACCESS_TOKEN}" >> .env.production
